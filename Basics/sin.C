void fillrandom() {
   ...
   TCanvas *c1 = new TCanvas("c1","The Power Function",200,10,700,900);
   c1->SetFillColor(18);
   ...
   //
   auto form1 = new TFormula("form1","4^-x");
   auto sqroot = new TF1("sqroot","4^-x",0,10);
   ...
   sqroot->Draw();
   //auto lfunction = new TPaveLabel(5,39,9.8,46,".");
